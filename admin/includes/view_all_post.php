    ...
    if(isset($_POST['checkBoxArray'])) {
        foreach($_POST['checkBoxArray'] as $postValueId) {
            ...
            switch($bulk_options) {
                ...
                $query = "INSERT INTO posts(post_title, post_author, post_date,
                post_image, post_tags, post_status, post_category_id, post_content) ";
    
                $query .= "VALUES('$post_title', '$post_author', now(),
                '$post_image', '$post_tags', '$post_status', $post_category_id, '$post_content') ";
...
<table class="table table-bordered table-hover">
    ...
    <div class="col-xs-4">
        ...
        echo "<td><a href='post.php?reset=$post_id'>Reset Views</a></td>";
        echo "</tr>";
